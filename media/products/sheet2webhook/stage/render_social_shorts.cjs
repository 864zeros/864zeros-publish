...
const BASE_DIR = path.resolve('C:/dev/864zeros-llc/LLC-DIV-4-GTM/videos/sheet2webhook/social_shorts');
...
(async () => {
    try {
        ...
        console.log('\n🎉 ALL SHEET2WEBHOOK SOCIAL SHORTS SUCCESSFULLY RENDERED & DISTRIBUTED!');
    } catch (err) {
