...
const BASE_DIR = path.resolve('C:/dev/864zeros-llc/LLC-DIV-4-GTM/videos/sheetsync/social_shorts');
...
(async () => {
    try {
        ...
        console.log('\n🎉 ALL SHEETSYNC LOCAL SOCIAL SHORTS SUCCESSFULLY RENDERED & DISTRIBUTED!');
    } catch (err) {
