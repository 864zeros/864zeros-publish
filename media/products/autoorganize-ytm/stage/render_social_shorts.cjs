...
const BASE_DIR = path.resolve('C:/dev/864zeros-llc/LLC-DIV-4-GTM/videos/autoorganize-ytm/social_shorts');
const AUDIO_DIR = path.join(BASE_DIR, 'audio');
const TEMP_DIR = path.join(BASE_DIR, 'temp_record');
const DAM_DIR = path.resolve('C:/dev/864zeros-publish/media/products/autoorganize-ytm');
...
(async () => {
    try {
        ...
        console.log('\n======================================================');
        console.log('ALL SOCIAL SHORTS SUCCESSFULLY RENDERED AND CATALOGED!');
        console.log('======================================================');
    } catch (err) {
