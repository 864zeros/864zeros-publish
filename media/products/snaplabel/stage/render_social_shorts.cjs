...
const BASE_DIR = path.resolve('C:/dev/864zeros-llc/LLC-DIV-4-GTM/videos/snaplabel/social_shorts');
...
(async () => {
    try {
        ...
        console.log('\n======================================================');
        console.log('ALL SNAPLABEL SOCIAL SHORTS SUCCESSFULLY RENDERED AND CATALOGED!');
        console.log('======================================================');
    } catch (err) {
