...
const BASE_DIR = path.resolve('C:/dev/864zeros-llc/LLC-DIV-4-GTM/videos/approvalworkflow/social_shorts');
...
(async () => {
    try {
        ...
        console.log('\n🎉 ALL APPROVALWORKFLOW LOCAL SOCIAL SHORTS SUCCESSFULLY RENDERED & DISTRIBUTED!');
    } catch (err) {
