...
SCRIPTS = {
    "pain": [
        {
            "id": "pain_scene1_hook",
            "text": "Typing sixty project milestones or duty rosters from a spreadsheet into Google Calendar one by one?",
            "lead": 0.25,
            "tail": 0.35
        },
        {
            "id": "pain_scene2_solution",
            "text": "Sheet2Calendar Sync turns Google Sheets rows into synced calendar events with two-way updates and zero duplicate clutter.",
            "lead": 0.2,
            "tail": 0.4
        },
        {
    ...
    "price": [
        {
            ...
            "text": "Why pay ninety-nine to two hundred ninety-nine dollars every single year just to sync spreadsheet rows to Google Calendar?",
            "lead": 0.25,
            "tail": 0.35
        },
        {
            "id": "price_scene2_solution",
            "text": "Sheet2Calendar Sync executes 100% locally inside Google Workspace with unlimited syncs, zero cloud servers, and zero subscriptions.",
            "lead": 0.2,
            "tail": 0.4
        },
        {
...
async def main():
    print("=== Generating Sheet2Calendar Sync Social Shorts Audio Stems ===")
    timeline_master = {}
