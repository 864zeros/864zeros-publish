...
BASE_DIR = r"C:\dev\864zeros-llc\LLC-DIV-4-GTM\videos\docwatermarker"
...
VARIANTS = {
    "pain": [
        {
            "id": "pain_scene1_hook",
            "text": "Ever spent 20 minutes manually removing 'DRAFT' watermarks from 40 pages and ruined every table?",
            "lead": 0.15,
            "tail": 0.25
        },
        {
            "id": "pain_scene2_solution",
            "text": "DocWatermarker Pro stamps and purges confidentiality notices across entire documents in seconds with header and footer precision. Zero broken layouts.",
            "lead": 0.15,
            "tail": 0.25
        },
        {
    ...
    "price": [
        {
            ...
            "text": "Why pay monthly subscription fees just to add confidentiality headers and footers?",
            "lead": 0.15,
            "tail": 0.25
        },
        {
            "id": "price_scene2_solution",
            "text": "DocWatermarker Pro runs 100% locally inside Google Docs Apps Script. Watermark contracts, NDAs, and legal drafts forever with zero cloud rent.",
            "lead": 0.15,
            "tail": 0.25
        },
        {
            "id": "price_scene3_cta",
            "text": "Just a one-time nine ninety-nine unlock. Available on the Google Workspace Marketplace for add-ons at eight sixty-four zeros dot com.",
            "lead": 0.15,
            "tail": 0.5
        }
    ]
...
async def main():
    print("=== Generating DocWatermarker Social Shorts Audio Stems ===")
    manifest = {}
