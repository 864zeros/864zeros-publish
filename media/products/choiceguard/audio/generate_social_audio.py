...
BASE_DIR = r"C:\dev\864zeros-llc\LLC-DIV-4-GTM\videos\choiceguard"
...
VARIANTS = {
    "pain": [
        {
            "id": "pain_scene1_hook",
            "text": "Two parents clicked the exact same volunteer slot at 8:01 AM. Who gets the seat?",
            "lead": 0.15,
            "tail": 0.25
        },
        {
            "id": "pain_scene2_solution",
            "text": "ChoiceGuard locks Google Forms with atomic LockService mutex protection. Exhausted choices disappear in real time with zero race conditions.",
            "lead": 0.15,
            "tail": 0.25
        },
        {
    ...
    "price": [
        {
            ...
            "text": "Stop paying monthly subscription fees just to count how many times an option was chosen in Google Forms.",
            "lead": 0.15,
            "tail": 0.25
        },
        {
            "id": "price_scene2_solution",
            "text": "ChoiceGuard runs 100% locally inside Google Apps Script. Limit seats, workshop signups, and inventory forever with zero cloud rent.",
            "lead": 0.15,
            "tail": 0.25
        },
        {
            "id": "price_scene3_cta",
            "text": "Just a one-time seven ninety-nine unlock. Available on the Google Workspace Marketplace for add-ons at eight sixty-four zeros dot com.",
            "lead": 0.15,
            "tail": 0.5
        }
    ]
...
async def main():
    print("=== Generating ChoiceGuard Social Shorts Audio Stems ===")
    manifest = {}
