...
const BASE_DIR = path.resolve('C:/dev/864zeros-llc/LLC-DIV-4-GTM/videos/form2docx/social_shorts');
...
(async () => {
    try {
        ...
        console.log('\n🎉 ALL FORM2DOCX LOCAL SOCIAL SHORTS SUCCESSFULLY RENDERED & DISTRIBUTED!');
    } catch (err) {
