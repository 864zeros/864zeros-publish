...
const BASE_DIR = path.resolve('C:/dev/864zeros-llc/LLC-DIV-4-GTM/videos/drivevault/social_shorts');
...
(async () => {
    try {
        ...
        console.log('\n🎉 ALL DRIVEVAULT SOCIAL SHORTS SUCCESSFULLY RENDERED & DISTRIBUTED!');
    } catch (err) {
